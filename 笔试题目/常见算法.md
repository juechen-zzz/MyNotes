...
> 如果生成的随机数满足要求，就返回该随机数，否则就不断生成直到一个满足要求的随机数位置。
>
> 若调用两次Rand7，就可以生成1-49之间的随机整数，只用到其中40个，来实现Rand10，拒绝剩下的9个数
>
> ![image-20210703212425290](../images/image-20210703212425290.png)
